    ...
    <div class="row-offcanvas row-offcanvas-left">
        ...
        <div id="detail-panel" class=" col-sm-10 col-xs-12 pull-right">
            ...
            <div class="col-12 col-sm-12 col-xs-12 col-lg-12 common-box without-heading">
                <form id="frmReportsRecoveries" name="frmReportsRecoveries" method="POST">
            ...
            <div class="col-12 col-sm-12 col-xs-12 col-lg-12 common-box without-heading">
                <h2>Recoveries Details</h2>
                <table class="display table footable dataTable no-footer footable-loaded" id="tblReportsRecoveries" role="grid" border="0" cellspacing="0" cellpadding="0">
                    <thead>
                    <tr role="row">
                ...
                <div>
                    <form target="_blank" action="../controllers/reports_controller.php" method="post">
                        ...
                        <input type="hidden" name="REPORT" id="REPORT" value="RECOVERIES">
...
<script src="../js/custom/reports_recoveries.js"></script>
<script>
    w3.includeHTML();
</script>
</body>
