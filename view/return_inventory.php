        ...
        <div id="detail-panel" class=" col-sm-10 col-xs-12 pull-right">
            ...
            <div class="col-12 col-sm-12 col-xs-12 col-lg-12 common-box">
                ...
                <form id="frmInventorySave" name="frmInventorySave" action="" method="POST">
                    ...
                    <div class="form-group col-lg-6 col-sm-6 col-xs-12">
                        <label for="" class="col-sm-5 col-xs-5">NO Of Return Items <span class="mandatory">*</span></label>
                        <div class="col-sm-7 col-xs-7">
                            <input class="form-control" id="returnItems" name="returnItems" type="text" disabled>
                        </div>
                    </div>
                    <div class="form-group col-lg-6 col-sm-6 col-xs-12">
                        <label for="" class="col-sm-5 col-xs-5">To Warehouse<span class="mandatory">*</span></label>
                        <div class="col-sm-7 col-xs-7">
                            <input class="form-control" id="toWarehouse" name="toWarehouse" type="text" disabled>
                        </div>
                    </div>
                </form>
            </div>
...
<script src="../js/custom/return_inventory.js"></script>
<script>
    w3.includeHTML();
    <?php $items = new Items() ?>
