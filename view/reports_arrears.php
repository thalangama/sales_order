...
checkAndAllow('reports_arrears.php');
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="row-offcanvas row-offcanvas-left">
        ...
        <div id="detail-panel" class=" col-sm-10 col-xs-12 pull-right">
            ...
            <div class="col-12 col-sm-12 col-xs-12 col-lg-12 common-box without-heading">
                <form id="frmReportsArrears" name="frmReportsArrears" method="POST">
            ...
            <div class="col-12 col-sm-12 col-xs-12 col-lg-12 common-box without-heading">
                ...
                <table class="display table footable dataTable no-footer footable-loaded" id="tblReportsArrears" role="grid" border="0" cellspacing="0" cellpadding="0">
                    <thead>
                    <tr role="row">
                        <th class="sorting_asc">No</th>
                        <th class="sorting">Month</th>
                        <th class="sorting">Arrears Amount</th>
                    </tr>
                    </thead>
                    <tbody>
                    </tbody>
                </table>
                <h3><div id="totalArrears"></div></h3>
                <div>
                    <form target="_blank" action="../controllers/reports_controller.php" method="post">
                        ...
                        <input type="hidden" name="REPORT" id="REPORT" value="ARREARS">
...
<script src="../js/custom/reports_arrears.js"></script>
<script>
    w3.includeHTML();
</script>
</body>
